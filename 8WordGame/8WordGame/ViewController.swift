...
class ViewController: UIViewController {
    ...
    func loadLevel() {
        ...
        letterBits.shuffle()
        print("Letter bits: \(letterBits)")
        print("Letter letterButtons: \(letterButtons)")
        print("Letter letterBits.count: \(letterBits.count)")
        print("Letter letterButtons.count: \(letterButtons.count)")
